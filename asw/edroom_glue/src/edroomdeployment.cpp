...
TEDROOMSignal CEDROOMSystemCommSAP::C3TM_ChannelCtrl_PTMChannelCtrl3__C5PBKGExec_PTMChannelCtrl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C5PBKGExec_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl3(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C2EPDManager_PBKGExecCtrl__C5PBKGExec_PBKGExecCtrl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C5PBKGExec_PBKGExecCtrl__C2EPDManager_PBKGExecCtrl(TEDROOMSignal signalOut){
...
void CEDROOMSystemCommSAP::SetLocalConnections(){
	...
	m_localCommSAP.Connect(mp_comp3->TMChannelCtrl3, mp_comp5->TMChannelCtrl, connections[0], 
					C3TM_ChannelCtrl_PTMChannelCtrl3__C5PBKGExec_PTMChannelCtrl, 
					C5PBKGExec_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl3);
 
	m_localCommSAP.Connect(mp_comp2->BKGExecCtrl, mp_comp5->BKGExecCtrl, connections[1], 
					C2EPDManager_PBKGExecCtrl__C5PBKGExec_PBKGExecCtrl, 
					C5PBKGExec_PBKGExecCtrl__C2EPDManager_PBKGExecCtrl);
