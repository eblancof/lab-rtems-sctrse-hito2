...
//Signal Conversion
	...
	static TEDROOMSignal C3TM_ChannelCtrl_PTMChannelCtrl3__C5PBKGExec_PTMChannelCtrl(TEDROOMSignal signal);
	static TEDROOMSignal C5PBKGExec_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl3(TEDROOMSignal signal);
 
//Signal Conversion
 
	static TEDROOMSignal C2EPDManager_PBKGExecCtrl__C5PBKGExec_PBKGExecCtrl(TEDROOMSignal signal);
	static TEDROOMSignal C5PBKGExec_PBKGExecCtrl__C2EPDManager_PBKGExecCtrl(TEDROOMSignal signal);
