...
bool ICUASW::EDROOMIsComponentFinished()
{
	...
	return ( EPDManager.EDROOMIsComponentFinished() && TM_ChannelCtrl.EDROOMIsComponentFinished() && HK_FDIRMng.EDROOMIsComponentFinished() && PBKGExec.EDROOMIsComponentFinished() && CEDROOMComponent::EDROOMIsComponentFinished());
